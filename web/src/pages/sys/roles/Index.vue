      ...
      <el-table-column :label="$t('l.Operation')" width="150">
        <template #default="scope">
          <el-button-group>
            ...
            <el-button type="warning" icon="Setting" :title="$t('l.Resources')"
              @click="open(Resources, { id: scope.row.id })"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
...
const { table, query, data, list, remove, select } = useList("/mgt/sys/roles")
</script>
