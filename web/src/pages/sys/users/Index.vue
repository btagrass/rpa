<template>
  <div>
    ...
    <el-table ref="table" :data="data.records" border @selection-change="select">
      ...
      <el-table-column :label="$t('l.Dept')" prop="dept.name"></el-table-column>
      <el-table-column :label="$t('l.UserName')" prop="userName"></el-table-column>
      <el-table-column :label="$t('l.FullName')" prop="fullName"></el-table-column>
      <el-table-column :label="$t('l.Mobile')" prop="mobile"></el-table-column>
      <el-table-column :label="$t('l.Password')" align="center">
        <template #default>******</template>
      </el-table-column>
      <el-table-column :label="$t('l.Frozen')" align="center">
      ...
      <el-table-column :label="$t('l.Operation')" width="150">
        <template #default="scope">
          <el-button-group>
            ...
            <el-button type="warning" icon="Setting" :title="$t('l.Roles')"
              @click="open(Roles, { id: scope.row.id })"></el-button>
          </el-button-group>
        </template>
      </el-table-column>
    </el-table>
...
const { table, query, data, list, remove, select } = useList("/mgt/sys/users")
</script>
